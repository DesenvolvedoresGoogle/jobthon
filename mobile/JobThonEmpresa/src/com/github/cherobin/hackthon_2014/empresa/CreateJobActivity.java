...
//					handler.sendEmptyMessage(2);
	...
	public void setStateSpinner() {
		...
		ArrayAdapter<String> adaptadorSpinner = new ArrayAdapter<String>(this,
				android.R.layout.simple_spinner_item, new String[] { "ESTADO", "AC",
	...
	private void setJobAreaSpinner() {
		ArrayAdapter<String> adaptadorSpinner = new ArrayAdapter<String>(this,
				android.R.layout.simple_spinner_item, new String[] { "Área", "Programador","Design", "Vendas", "Administrativo"});
